...
Ext = { version: "3.4.1.1", versionDetail: { major: 3, minor: 4, patch: 1.1 } };
...
(function () {
  var g = 0,
    ...
    B = d && n(/version\/4/),
    j = !a && n(/msie/),
    G = j && ((n(/msie 7/) && q != 8 && q != 9 && q != 10) || q == 7),
    E = j && ((n(/msie 8/) && q != 7 && q != 9 && q != 10) || q == 8),
    C = j && ((n(/msie 9/) && q != 7 && q != 8 && q != 10) || q == 9),
    i = j && ((n(/msie 10/) && q != 7 && q != 8 && q != 9) || q == 10),
    J = j && n(/msie 6/),
    K = j && (J || G || E || C),
    c = !z && n(/gecko/),
    M = c && n(/rv:1\.8/),
    ...
    w = [],
    o = Ext.emptyFn,
    x = Ext.apply({}, { constructor: o, toString: o, valueOf: o }),
    l = function () {
      var e = l.caller.caller;
  ...
  Ext.apply(k, {
    ...
    callParent: function (e) {
      ...
      return (
        ...
        (
          t.$previous ||
          ((t = t.$owner ? t : t.caller) && t.$owner.superclass.self[t.$name])
        ).apply(this, e || b)
      );
    },
  });
  k.prototype = {
    ...
    callParent: function (t) {
      var N,
        e =
          (N = this.callParent.caller) &&
          (N.$previous ||
            ((N = N.$owner ? N : N.caller) && N.$owner.superclass[N.$name]));
      return e.apply(this, t || b);
    },
  };
  if (J) {
    try {
  ...
  Ext.apply(Ext, {
    SSL_SECURE_URL: r && j ? 'javascript:""' : "about:blank",
    isStrict: u,
    isSecure: r,
    isReady: false,
    ...
    applyIf: function (t, N) {
      if (t) {
        for (var e in N) {
          if (!Ext.isDefined(t[e])) {
            t[e] = N[e];
          }
        }
      }
    ...
    extend: (function () {
      ...
      return function (S, P, R) {
        ...
        Q.superclass = Q.supr = function () {
          return N;
        };
        Q.override = t;
        Ext.override(S, R);
        S.extend = function (T) {
          return Ext.extend(S, T);
        };
        return S;
      };
    })(),
    ...
    Base: k,
    namespaceCache: {},
    createNamespace: function (R, O) {
      var e = Ext.namespaceCache,
        P = O ? R.substring(0, R.lastIndexOf(".")) : R,
        U = e[P],
        S,
        N,
        t,
    ...
    define: function (R, P, N) {
      ...
      if (t) {
        delete P.override;
        T = Ext.getClassByName(t);
        Ext.override(T, P);
      } else {
        if (R) {
          O = Ext.createNamespace(R, true);
          e = R.substring(R.lastIndexOf(".") + 1);
        }
        T = function S() {
        ...
        T.$isClass = true;
        T.callParent = Ext.Base.callParent;
        ...
        if (!T.prototype.$isClass) {
          Ext.applyIf(T.prototype, k.prototype);
        }
        T.prototype.self = T;
        if (P.xtype) {
          Ext.reg(P.xtype, T);
        }
        T = P.singleton ? new T() : T;
        if (R) {
          O[e] = T;
        }
      }
    ...
    override: function (P, R) {
      ...
      if (R) {
        if (P.$isClass) {
          ...
          Ext.addMembers(P, P.prototype, R, true);
          if (Q) {
            Ext.addMembers(P, P, Q);
          }
        } else {
          if (typeof P == "function") {
            N = P.prototype;
            Ext.apply(N, R);
            if (Ext.isIE && R.hasOwnProperty("toString")) {
            ...
            if (e && e.$isClass) {
              for (t in R) {
                if (R.hasOwnProperty(t)) {
                  ...
                  if (typeof O == "function") {
                    if (e.$className) {
                      O.displayName = e.$className + "#" + t;
                    }
                    O.$name = t;
                    O.$owner = e;
                    O.$previous = P.hasOwnProperty(t) ? P[t] : l;
                  }
                  P[t] = O;
                }
              }
              ...
              Ext.apply(P, R);
              if (!P.constructor.$isClass) {
                P.constructor.prototype.callParent = k.prototype.callParent;
                P.constructor.callParent = k.callParent;
              }
            }
          }
        }
    ...
    urlEncode: function (Q, P) {
      var N,
        t = [],
        O = encodeURIComponent;
      Ext.iterate(Q, function (e, R) {
        N = Ext.isEmpty(R);
        Ext.each(N ? e : R, function (S) {
          t.push(
            "&",
            O(e),
            "=",
    ...
    urlDecode: function (N, t) {
      ...
      var Q = {},
        ...
        e,
        O;
      Ext.each(P, function (S) {
        S = S.split("=");
        e = R(S[0]);
        O = R(S[1]);
        Q[e] = t || !Q[e] ? O : [].concat(Q[e]).concat(O);
      });
      return Q;
    },
    ...
    toArray: (function () {
      return j
        ? function (N, Q, O, P) {
            ...
            return P.slice(Q || 0, O || P.length);
          }
        : function (e, N, t) {
            return Array.prototype.slice.call(e, N || 0, t || e.length);
          };
    })(),
    isIterable: function (e) {
      ...
      if (/NodeList|HTMLCollection/.test(f.call(e))) {
        return true;
      }
      return (
        (typeof e.nextNode != "undefined" || e.item) && Ext.isNumber(e.length)
      );
    },
    each: function (P, O, N) {
      if (Ext.isEmpty(P, true)) {
        return;
      }
      if (!Ext.isIterable(P) || Ext.isPrimitive(P)) {
        P = [P];
      }
      for (var t = 0, e = P.length; t < e; t++) {
        if (O.call(N || P[t], P[t], t, P) === false) {
          return t;
        }
      }
    },
    iterate: function (N, t, e) {
      if (Ext.isEmpty(N)) {
        return;
      }
      if (Ext.isIterable(N)) {
    ...
    getDom: function (N, t) {
      ...
      if (N.dom) {
        ...
        if (typeof N == "string") {
          var O = s.getElementById(N);
          if (O && j && t) {
            if (N == O.getAttribute("id")) {
              return O;
            } else {
              return null;
            }
    ...
    getBody: function () {
      return Ext.get(s.body || s.documentElement);
    },
    getHead: (function () {
      var e;
      return function () {
        if (e == undefined) {
          e = Ext.get(s.getElementsByTagName("head")[0]);
        }
        return e;
      };
    })(),
            ...
            return function (t) {
              if (t && t.tagName != "BODY") {
                Ext.enableNestedListenerRemoval
                  ? Ext.EventManager.purgeElement(t, true)
                  : Ext.EventManager.removeAll(t);
                e = e || s.createElement("div");
                e.appendChild(t);
                e.innerHTML = "";
                delete Ext.elCache[t.id];
              }
            };
          })()
        : function (e) {
            if (e && e.parentNode && e.tagName != "BODY") {
              Ext.enableNestedListenerRemoval
                ? Ext.EventManager.purgeElement(e, true)
    ...
    isEmpty: function (t, e) {
      return (
        t === null ||
        t === undefined ||
        (Ext.isArray(t) && !t.length) ||
        (!e ? t === "" : false)
      );
    },
    isArray: function (e) {
      return f.apply(e) === "[object Array]";
    },
    isDate: function (e) {
      return f.apply(e) === "[object Date]";
    },
    isObject: function (e) {
    ...
    isFunction: function (e) {
      return f.apply(e) === "[object Function]";
    },
    isNumber: function (e) {
  ...
  createInterceptor: function (b, a) {
    ...
    return !Ext.isFunction(b)
      ...
      : function () {
          ...
          b.target = e;
          b.method = c;
          return b.apply(a || e || window, d) !== false
            ? c.apply(e || window, d)
            : null;
        };
  },
...
(function () {
  ...
  (function () {
    ...
    Ext.lib.Dom = {
      ...
      getDocumentHeight: function () {
        return f(
          !e ? g.body.scrollHeight : g.documentElement.scrollHeight,
          this.getViewportHeight()
        );
      },
      getDocumentWidth: function () {
        return f(
          !e ? g.body.scrollWidth : g.documentElement.scrollWidth,
        ...
        if (k != n) {
          if (k.getBoundingClientRect) {
            ...
            while (j && j != n) {
              if (
                !Ext.isOpera ||
                (j.tagName != "TR" && !c(j).isStyle("display", "inline"))
              ) {
                u -= j.scrollLeft;
                r -= j.scrollTop;
              }
    ...
    var x = {
      ...
      resolveTextNode: Ext.isGecko
        ? function (G) {
            ...
            if (
              F == "[xpconnect wrapped native prototype]" ||
              F == "[object XULElement]"
            ) {
              return;
            }
      ...
      getRelatedTarget: function (F) {
        ...
        return this.resolveTextNode(
          F.relatedTarget ||
            (/(mouseout|mouseleave)/.test(F.type)
              ? F.toElement
              : /(mouseover|mouseenter)/.test(F.type)
              ? F.fromElement
              : null)
        );
      },
  ...
  Ext.lib.Ajax = (function () {
    var g = ["Msxml2.XMLHTTP.3.0", "Msxml2.XMLHTTP"],
      d = "Content-Type";
    function h(v) {
      var t = v.conn,
        w,
    ...
    function e(v, u, t, s) {
      return {
        tId: v,
        status: t ? -1 : 0,
        statusText: t ? "transaction aborted" : "communication failure",
        isAbort: t,
        isTimeout: s,
        argument: u,
      };
          ...
          if (!A.disabled && t) {
            if (/select-(one|multiple)/i.test(v)) {
              ...
              if (!/file|undefined|reset|button/i.test(v)) {
                if (
                  !(/radio|checkbox/i.test(v) && !A.checked) &&
                  !(v == "submit" && s)
                ) {
                  z += w(t) + "=" + w(A.value) + "&";
                  s = /submit/i.test(v);
    ...
    g.AnimBase.prototype = {
      ...
      getAttr: function (k) {
        ...
        return !!l[2] || (m.getStyle("position") == "absolute" && !!l[3])
          ? m.dom["offset" + l[0].charAt(0).toUpperCase() + l[0].substr(1)]
          : 0;
      },
      ...
      Ext.apply(g.Motion.prototype, {
        ...
        getAttr: function (n) {
          var p = this,
            o = m.getAttr;
          return l.test(n)
            ? [o.call(p, "left"), o.call(p, "top")]
            : o.call(p, n);
        },
        doMethod: function (n, q, o) {
          var p = this;
          return l.test(n)
            ? g.Bezier.getPosition(
                p.runAttrs[n],
                p.method(p.curFrame, 0, 100, p.totalFrames) / 100
              )
  ...
  (function () {
    ...
    Ext.apply(f.Easing, {
      ...
      elasticBoth: function (l, j, q, o, k, n) {
        ...
        return l < 1
          ? -0.5 * (k * g(2, 10 * (l -= 1)) * e(((l * o - m) * (2 * i)) / n)) +
              j
          : k * g(2, -10 * (l -= 1)) * e(((l * o - m) * (2 * i)) / n) * 0.5 +
              q +
              j;
      },
      ...
      bounceBoth: function (k, j, m, l) {
        return k < l / 2
          ? f.Easing.bounceIn(k * 2, 0, m, l) * 0.5 + j
          : f.Easing.bounceOut(k * 2 - l, 0, m, l) * 0.5 + m * 0.5 + j;
      },
    });
  })();
  (function () {
